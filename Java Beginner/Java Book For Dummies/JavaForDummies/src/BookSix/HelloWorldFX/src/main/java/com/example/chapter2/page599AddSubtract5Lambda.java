...
public class page599AddSubtract5Lambda extends Application
{
...
/*→25 The setOnAction method for the Add button uses a lambda expression
...
expression to specify that the method named btnSubtract_Click
should be called when the user clicks the button.
→50 The btnAdd_Click method increments the counter and updates the
label’s text to reflect the updated counter value.
→56 Likewise, the btnSubtract_Click method decrements the counter and
